...
class Session(Base):
    ...
    status: Mapped[SessionStatus] = mapped_column(Enum(SessionStatus), nullable=False, server_default="scheduled")
    half_duration_minutes: Mapped[int] = mapped_column(Integer, server_default="40")
...
class TimerState(Base):
    ...
    current_half: Mapped[int] = mapped_column(SmallInteger, server_default="1")
    status: Mapped[TimerStatus] = mapped_column(Enum(TimerStatus), nullable=False, server_default="stopped")
    elapsed_seconds: Mapped[int] = mapped_column(Integer, server_default="0")
